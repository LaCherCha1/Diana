...
<head>
    ...
    <title>Programa Manifestando mis sueños</title>
                ...
                <tr>
                    <td class="bg_white email-section">
                        <div class="heading-section" style="text-align: left;">
                            ...
                            <p>
                                Ahora puedes crearte una cuenta para poder obtener acceso al area de miembros
                            </p>
                           <center>
                            <a href="{{route('registro',['token'=>$token])}}" style="background-color: #3490dc;/* border: 1px solid #3490dc; */border-radius:3px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;line-height:44px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;">
                                Registrarse &rarr;</a>
                           </center>
                        </div>
                    </td>
